...
UserSymptomsMaster userSymptomsMasterFromJson(String str) =>
    UserSymptomsMaster.fromJson(json.decode(str));

String userSymptomsMasterToJson(UserSymptomsMaster data) =>
...
class UserSymptomsMaster {
  ...
  factory UserSymptomsMaster.fromJson(Map<String, dynamic> json) =>
      UserSymptomsMaster(
